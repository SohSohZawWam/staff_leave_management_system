...
@section('content')
    <div class="max-w-3xl mx-auto">
        <div class="cu-card cu-card-body">
            <h2 class="cu-page-title mb-1">{{ __('admin.edit_user') }}</h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            <div>
                <label for="role" class="cu-label">{{ __('common.role') }}</label>
                <select name="role" id="role" class="cu-select">
                    <option value="admin" {{ old('role', $user->role) == 'admin' ? 'selected' : '' }}>
                        {{ __('common.administrator') }}
                    </option>
                    <option value="department_head" {{ old('role', $user->role) == 'department_head' ? 'selected' : '' }}>
                        {{ __('common.department_head') }}
                    </option>
