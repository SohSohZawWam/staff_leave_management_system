...
@section('title', __('admin.staff_details'))

@section('content')
<div class="space-y-6">
    <div class="cu-card-header">
        <div>
            <h2 class="cu-page-title">{{ __('admin.staff_details') }}</h2>
            <p class="cu-muted mt-1">{{ __('admin.staff_details_subtitle') }}</p>
        </div>
        <a href="{{ route('admin.users.index') }}" class="cu-btn-secondary">{{ __('common.back') }}</a>
    </div>
